...
public class MyDatabaseHelper extends SQLiteOpenHelper {
    ...
    public static final String DB_NAME = "db_kisi";
    ...
    public static final String CREATE_TABLE = "CREATE TABLE " + TABLE_NAME + "(" + COL_ID + " INTEGER PRIMARY KEY AUTOINCREMENT, " + COL_AD + " TEXT," +
            COL_SOYAD + " TEXT );";
