...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <table class="auto-style1">
        ...
        <tr>
            <td><a href="Image_Ornek.aspx">Image</a></td>
           
        </tr>
        <tr>
            <td class="auto-style2"><a href="ImageButton_Ornek.aspx">Image Button</a></td>
           
        </tr>
        <tr>
            <td class="auto-style2"><a href="ImageMap_Ornek.aspx">ImageMap</a></td>
           
        </tr>
        <tr>
            <td class="auto-style2"><a href="Calendar_Ornek.aspx">Calendar</a></td>
           
        </tr>
        <tr>
            <td class="auto-style2">Validation Kontrolleri</td>
