...
&nbsp;<asp:Button ID="ButtonMezuniyet" runat="server" OnClick="ButtonMezuniyet_Click" Text="GÖNDER" />
        ...
        <br />
        İl :
        <asp:DropDownList ID="DropDownListIller" runat="server" AutoPostBack="True" OnSelectedIndexChanged="DropDownListIller_SelectedIndexChanged">
        </asp:DropDownList>
        <br />
        İlçeler: <asp:DropDownList ID="DropDownListIlceler" runat="server">
        </asp:DropDownList>
