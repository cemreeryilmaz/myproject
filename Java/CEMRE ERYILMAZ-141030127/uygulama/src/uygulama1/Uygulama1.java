	...
	public Uygulama1() {
		...
		comboBox.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				metinAlaný.setText(mod.getSelectedItem().toString());
			}
		});
		...
		metinAlaný.setBounds(203, 31, 177, 25);
		...
		btnNewButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				for (int i = 0; i < mod.getSize(); i++) {
					if(mod.getElementAt(i).toString().equals(metinAlaný.getText()))
					{
						return;
					}
				...
				mod.insertElementAt(metinAlaný.getText(), 0);
			}
		});
		...
		btnNewButton_2.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				if(mod.getSize()>0){
					int index = comboBox.getSelectedIndex();
					mod.removeElementAt(index);
					mod.insertElementAt(metinAlaný.getText(), index);
					mod.setSelectedItem(metinAlaný.getText());
					}
			}
		});
