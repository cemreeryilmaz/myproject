	...
	public uygulama4() {
		...
		comboBox.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				metinAlaný.setText(model.getSelectedItem().toString());
			}
		});
		...
		metinAlaný.setBounds(236, 34, 188, 27);
		...
		btnNewButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				String eklenecek = metinAlaný.getText();
		...
		btnNewButton_2.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				if(model.getSize()>0){
					int index = comboBox.getSelectedIndex();
					model.removeElementAt(index);
					model.insertElementAt(metinAlaný.getText(), index);
					model.setSelectedItem(metinAlaný.getText());
					}
			}
		});
