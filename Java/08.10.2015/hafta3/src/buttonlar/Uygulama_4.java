		...
		tglbtnNewToggleButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				if (tglbtnNewToggleButton.isSelected()) {
					...
					lblNewLabel.setIcon(new ImageIcon("C:\\Users\\Administrator\\Desktop\\Açýk.jpg"));				
				}
				else {
					tglbtnNewToggleButton.setText("Aç");
					lblNewLabel.setIcon(new ImageIcon("C:\\Users\\Administrator\\Desktop\\Kapalý.jpg"));
				}
