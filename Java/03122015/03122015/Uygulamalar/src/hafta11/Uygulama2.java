	...
	public Uygulama2() {
		...
		btnBoMesaj.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				JOptionPane.showMessageDialog(null, "Bu bir boþ mesaj örneðidir",
				"Boþ Mesaj", JOptionPane.PLAIN_MESSAGE, null);
			}
		});
		...
		btnHataMesaj.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				JOptionPane.showMessageDialog(null, "Hata Mesajý Örneðidir", "Hata Mesajý",
		...
		btnUyarMesaj.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				JOptionPane.showMessageDialog(null, "Bu bir uyarý mesajýdýr",
				"Uyarý Mesajý", JOptionPane.WARNING_MESSAGE, null);
			}
		});
		...
		btnBilgiMesaj.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				JOptionPane.showMessageDialog(null, "Bu bir bilgi mesajýdýr", "Bilgi Mesajý",
		...
		btnSoruMesaj.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				JOptionPane.showMessageDialog(null, "Bu bir soru mesajýdýr", "Soru Mesajý", 
