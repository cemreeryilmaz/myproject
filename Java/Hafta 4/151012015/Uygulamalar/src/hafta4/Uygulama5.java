...
public class Uygulama5 extends JFrame {
	...
	private JTextField txtGün;
	private JTextField txtAy;
	private JTextField txtYýl;
	...
	public Uygulama5() {
		...
		spnTarih.addChangeListener(new ChangeListener() {
			public void stateChanged(ChangeEvent arg0) {
				txtGün.setText(tarihmodeli.getDate().getDate()+"");
				txtAy.setText(tarihmodeli.getDate().getMonth()+1+"");
				txtYýl.setText(tarihmodeli.getDate().getYear()+1900+"");
			}
		});
		...
		txtGün = new JTextField();
		txtGün.setEditable(false);
		txtGün.setBounds(12, 63, 154, 26);
		contentPane.add(txtGün);
		txtGün.setColumns(10);
		...
		txtYýl = new JTextField();
		txtYýl.setEditable(false);
		txtYýl.setColumns(10);
		txtYýl.setBounds(12, 141, 154, 26);
		contentPane.add(txtYýl);
