...
public class Uygulama3 extends JFrame {
	...
	public Uygulama3() throws ParseException {
		...
		MaskFormatter adýFormat=new MaskFormatter("**********");
		adýFormat.setInvalidCharacters("1234567890");
		MaskFormatter doðumTarihiFormat=new MaskFormatter("##/##/####");
		doðumTarihiFormat.setPlaceholderCharacter('_');
		...
		final JFormattedTextField txtAdý = new JFormattedTextField(adýFormat);
		txtAdý.setBounds(10, 89, 179, 20);
		...
		final JFormattedTextField txtDoðumTarihi = new JFormattedTextField(doðumTarihiFormat);
		txtDoðumTarihi.setBounds(10, 120, 179, 20);
		contentPane.add(txtDoðumTarihi);
		...
		final JTextArea txtSonuç = new JTextArea();
		txtSonuç.setBounds(10, 185, 281, 110);
		contentPane.add(txtSonuç);
		
		JButton btnKaydet = new JButton("Kaydet");
		btnKaydet.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				txtSonuç.setText("Girilen T.C. Numarasý:"+txtTcNo.getText()+"\n"+
			"Girilen telefon numarasý:"+txtTelefon.getText()+"\n"+
			"Girilen ad:"+txtAdý.getText()+"\n"+
			"Girilen doðum tarihi:"+txtDoðumTarihi.getText());					
			}
		});
